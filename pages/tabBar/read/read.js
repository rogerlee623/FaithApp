...
const _sfc_main = {
  ...
  methods: {
    ...
    getList() {
      ...
      api_index.getListInfoData(1, param).then((res) => {
        if (this.page > 1) {
          if (res.info)
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-ee741e3a"]]);
